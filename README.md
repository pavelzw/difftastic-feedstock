...
Documentation: https://difftastic.wilfred.me.uk/
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/difftastic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/difftastic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install difftastic
```
...
It is possible to list all of the versions of `difftastic` available on your platform:
...
```
pixi search difftastic --channel conda-forge
```
